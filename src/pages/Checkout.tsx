...
const Checkout = () => {
	...
	return (
		<div className="container mx-auto px-4 lg:px-8 py-6 lg:py-12 max-w-5xl">
			...
			<h1 className="font-display text-2xl lg:text-3xl font-semibold text-foreground mb-10">
				Checkout
			</h1>
			...
			<form onSubmit={handleSubmit}>
				<div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
					<div className="lg:col-span-3 space-y-8">
						<section>
							<h2 className="text-xs font-body uppercase tracking-widest text-foreground mb-4">
								Contact
							</h2>
							<Input
								type="email"
						...
						<section>
							...
							<div className="grid grid-cols-2 gap-3">
								...
								<Input
									placeholder="Address"
									required
									className="col-span-2 font-body text-sm h-11"
								/>
								<Input
									placeholder="City"
									required
