  ...
  if (!product) {
    return (
      <div className="container mx-auto px-4 py-20 text-center">
        ...
        <Link to="/" className="text-accent font-body text-sm mt-4 inline-block hover:underline">
          Back to shop
        </Link>
      </div>
    );
        ...
        <div className="lg:py-4">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm font-body font-medium text-foreground">{product.rating}</span>
            </div>
          ...
          <div className="flex items-center gap-3 mb-6">
            <span className="text-xl font-body font-semibold text-foreground">${product.price}</span>
          ...
          <div className="mb-8">
            ...
            <div className="inline-flex items-center border border-border rounded-sm">
              ...
              <span className="w-10 text-center text-sm font-body font-medium text-foreground">{quantity}</span>
              <button
          ...
          <div className="mt-10 pt-8 border-t border-border space-y-3">
            {["Free shipping over $200", "30-day easy returns", "Sustainably made"].map((feature) => (
              <p key={feature} className="text-xs font-body text-muted-foreground flex items-center gap-2">
